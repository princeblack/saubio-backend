...
@ApiTags('employee')
@Controller('employee/providers')
@UseGuards(AccessTokenGuard, RolesGuard)
@Roles('employee')
export class EmployeeProviderIdentityController {
  constructor(private readonly identityService: EmployeeProviderIdentityService) {}
