...
describeWithDatabase('Dashboard APIs (e2e)', () => {
  ...
  describe('GET /employee/dashboard', () => {
    ...
    beforeAll(async () => {
      ...
      const moduleRef = await Test.createTestingModule({
        ...
        providers: [EmployeeDashboardService, PrismaService],
      })
    ...
    it('returns dashboard metrics with expected shape', async () => {
      const response = await request(app.getHttpServer()).get('/employee/dashboard').expect(200);
